...
public final class Example001OverviewOfFeaturesTest {
    ...
    public void parsingExample() throws PatternMatchException {
        final String input = "31 Dec 2003 - 16 aug 2008";

        final Parse parse = dateRange.parse(input);
    ...
    public void matchingExample() {
        ...
        final String badInput = "31 12 2003 - 16 08 2008";
